...
<!-- TRACK_RECORD_START -->
## Live Track Record (2 matches)

| Metric | Value | Random baseline |
|--------|-------|-----------------|
| W/D/L accuracy | 50.0% | 33.3% |
| Log-loss | 1.3580 | 1.0986 |
| Brier score | 0.8971 | 0.6667 |

### Per-match predictions

| Date | Match | H% / D% / A% | Result | LL | ✓ |
|------|-------|--------------|--------|----|---|
| 2026-06-17 | Portugal vs DR Congo | 84%/12%/4% | Draw (1-1) | 2.098 | ✗ |
| 2026-06-17 | England vs Croatia | 54%/27%/19% | England (4-2) | 0.618 | ✓ |
